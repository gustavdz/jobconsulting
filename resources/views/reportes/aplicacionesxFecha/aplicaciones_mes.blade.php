...
@section('js')
    ...
    <script src="{{ asset('../js/reporte-aplicaciones-registro-mes.js') }}"></script>
...
<script rel="javascript" type="text/javascript">
    ...
    function filtrarData(){
        ...
        $.ajax({
        type: 'POST',
        url: '/reportes/dataAplicacionesRegistro?desdeFiltro='+desdeFiltro+' 00:00:00'+'&hastaFiltro='+hastaFiltro+' 23:59:59',
        data: {
