...
<div class="main-card mb-3 card border-info">
    <div class="card-header">
        ...
        <div class="btn-actions-pane-right">
            <div  role="group" class="btn-group-sm btn-group">
                <button class="mb-2 mr-2 btn-icon btn-shadow btn-dashed btn btn-outline-success" onclick="editar_formacion({{ $formacion->id }},'{{ $formacion->institucion_educativa }}','{{ $formacion->titulo }}','{{ $formacion->inicio }}','{{ $formacion->fin }}','{{ $formacion->oferta_academica_id }}')"><i class="pe-7s-pen btn-icon-wrapper" > </i> Editar</button>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col">
                <p>{{ $formacion->oferta_academica->nombre ?? '' }}.</p>
            </div>
            <div class="col">
